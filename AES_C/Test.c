...
{
	unsigned char input[] = {11,12,84, 104, 105, 115, 32, 105, 115, 32, 97, 32, 116, 101, 115, 116, 33, 84, 104, 105, 115, 32, 105, 115, 32, 97, 32, 116, 101, 115, 116, 33, 84, 104, 105, 115, 32, 105, 115, 32, 97, 46};
...
//	unsigned char 
	...
	AESModeOfOperation_set_mode(MODE_OFB);
	AESModeOfOperation_set_iv(iv);
    int olen = sizeof input;

    memcpy(temp, input, sizeof input);
	int len = AESModeOfOperation_Encrypt(temp, olen, output);
	printf("len = %d\n", len);
    printf("output");
	print(output, len);
	printf("\n\nDecrypt----------\n");
	len = AESModeOfOperation_Decrypt(output, len, input);
	printf("len = %d\n", len);
    printf("input");
	print(input, len);
